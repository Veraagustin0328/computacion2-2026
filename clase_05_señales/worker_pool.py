...
class WorkerPool:
        ...
        while True:
            try:
                ...
                if pid in self.workers:
                    ...
                    print(f"[SUPERVISOR] Worker {info['id']} (pid {pid}) termino con codigo {codigo}")
    ...
    def _worker_main(self, worker_id):
        ...
        def worker_shutdown(sig, frame):
            print(f"[Worker {worker_id}] Recibi SIGTERM, terminando...")
            os._exit(0)
    ...
    def spawn_worker(self, worker_id):
        ...
        if pid == 0:
            ...
            print(f"[SUPERVISOR] Worker {worker_id} iniciado (PID {pid})")
    ...
    def run(self):
        ...
        while self.ejecutando:
            ...
            if len(self.workers) < self.num_workers and self.ejecutando:
                print(f"[SUPERVISOR] Solo {len(self.workers)} workers activos, spawneando mas")
        ...
        print("[SUPERVISOR] Todos los workers terminaron")
